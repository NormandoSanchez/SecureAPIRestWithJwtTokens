...
public partial class IftopActualizacionResultado
{
    ...
    public DateTime OpaFinclusion { get; set; }

    public DateTime? OpaAtendida { get; set; }

    public bool OpaResultado { get; set; }

    public int OpaReintentos { get; set; }
